...
if __name__ == '__main__':
    ...
    schedule.every().day.at("19:02",'Europe/Moscow').do(job, type="taurus", group_id='229860740')
    schedule.every().day.at("19:03",'Europe/Moscow').do(job, type="gemini", chat_id='@gemini_the', group_id='229837895')
    schedule.every().day.at("19:04",'Europe/Moscow').do(job, type="cancer", group_id='229860780')
    schedule.every().day.at("19:05",'Europe/Moscow').do(job, type="leo", group_id='229860665')
    schedule.every().day.at("19:06",'Europe/Moscow').do(job, type="virgo", group_id='229860810')
    schedule.every().day.at("19:07",'Europe/Moscow').do(job, type="libra", group_id='229860834')
    schedule.every().day.at("19:08",'Europe/Moscow').do(job, type="scorpio", group_id='229860866')
    schedule.every().day.at("19:09",'Europe/Moscow').do(job, type="sagittarius", group_id='229860894')
